...
const Footer = () => {
  return (
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
        ...
        <p className='text-sm max-w-[300px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium quod magni qui numquam earum laudantium illum nemo in, doloribus commodi.</p>
        <div>
       ...
       className='text-white text-center mt-8 pt-8 border-t-2'>Copyright &copy; 2025 Coders Cafe .All rights reserved.</motion.p>
    </div>
    </div>
  )
}
